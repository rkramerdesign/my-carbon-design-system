...
import {
  ...
  ri,
  si
} from "./chunk-VLH2GE4H.js";
import "./chunk-X7QOQVYG.js";
import "./chunk-BWMZNDQO.js";
import {
  i,
  scope
} from "./chunk-IICOQCIW.js";
import {
  __toESM
...
var applyDecorators = (storyFn, decorators3) => Ur((context) => import_react.default.createElement(storyFn, context), decorators3);
...
async function renderToCanvas({ storyContext, unboundStoryFn, showMain, showException, forceRemount }, canvasElement) {
  let { renderElement, unmountElement } = await import("./react-18-AJYT4NU2.js"), Story = unboundStoryFn, content = storyContext.parameters.__isPortableStory ? import_react2.default.createElement(Story, { ...storyContext }) : import_react2.default.createElement(ErrorBoundary, { key: storyContext.id, showMain, showException }, import_react2.default.createElement(Story, { ...storyContext })), element = Wrapper ? import_react2.default.createElement(Wrapper, null, content) : content;
...
var r = (n, s) => Ie2(n, "name", { value: s, configurable: true });
var Jr = (n, s) => () => (s || n((s = { exports: {} }).exports, s), s.exports);
var wr = (n, s, a, p) => {
  if (s && typeof s == "object" || typeof s == "function")
    for (let c of gr(s))
      !hr.call(n, c) && c !== a && Ie2(n, c, { get: () => s[c], enumerable: !(p = Tr(s, c)) || p.enumerable });
  return n;
};
var Pr = (n, s, a) => (a = n != null ? dr(xr(n)) : {}, wr(
  ...
  s || !n || !n.__esModule ? Ie2(a, "default", { value: n, enumerable: true }) : a,
  n
));
var dt = Jr((fe, yt) => {
  (function(n, s) {
    ...
    function De({ allowSquaredProperties: e, allowKeyTypes: t, allowReadonly: o, allowOptional: i2 }) {
      return x({
...
r(K2, "isDefaultValueBlacklisted");
var st = r((n) => {
  if (!n)
    return "";
  if (typeof n == "string")
...
function Ue(n) {
  return n === "compact" ? Ur2 : n === "preserve" ? Mr : n;
}
r(Ue, "getJoiner");
function Ur2(n, s = v) {
...
function Dt2({ tsType: n, required: s }) {
  if (n == null)
    return null;
  let a = n.name;
...
var jsxDecorator = (storyFn, context) => {
  let jsx = hs(void 0), story = storyFn(), skip = skipJsxRender(context), options = { ...defaultOpts, ...(context == null ? void 0 : context.parameters.jsx) || {} }, storyJsx = context.originalStoryFn(context.args, context);
  return Dt(() => {
    if (skip) return;
    let sourceJsx = mdxToJsx(storyJsx), rendered = renderJsx(sourceJsx, options);
    rendered && jsx.current !== rendered && (Qn(rendered, context), jsx.current = rendered);
  }), story;
};
...
function __definePreview(input) {
  let composed, preview = { _tag: "Preview", input, get composed() {
    ...
    return composed = he(K([...Ie(), ...addons ?? [], rest])), composed;
  }, meta(meta) {
...
function setProjectAnnotations(projectAnnotations) {
  return ri(INTERNAL_DEFAULT_PROJECT_ANNOTATIONS), si(projectAnnotations);
}
...
function composeStory(story, componentAnnotations, projectAnnotations, exportsName) {
  return Oo(story, componentAnnotations, projectAnnotations, globalThis.globalProjectAnnotations ?? INTERNAL_DEFAULT_PROJECT_ANNOTATIONS, exportsName);
}
function composeStories(csfExports, projectAnnotations) {
  return ai(csfExports, projectAnnotations, composeStory);
}
var _a;
